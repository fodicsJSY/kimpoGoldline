...
--------기본시간대 누적 수--------
   ...
   SELECT
    ...
    COUNT(CASE WHEN H.event_status = '1' AND H.role_code IN ('DL20231125_000284') THEN 1 END) AS GOCHON1_24COUNT,
    COUNT(CASE WHEN H.event_status = '1' AND H.role_code IN ('DL20231125_000284') THEN 1 END) AS GOCHON2_24COUNT,
